    ...
    public void save(User model) {
        if (model.getId() == null) {
            model.setId(query("insert into user ( username, password, first_name, last_name, email ) " +
                    ...
                    .addParameter("username", model.getUsername()) //.bind(model) not possible because of fullName
                    .addParameter("password", model.getPassword())
                    .addParameter("firstName", model.getFirstName())
                    .addParameter("lastName", model.getLastName())
            ...
            model.setId(query("update user set username = :username, password = :password, " +
                    ...
                    .addParameter("id", model.getId()) //.bind(model) not possible because of fullName
